...
// Body-derived pricing — the pricing function reads parsed body and returns the price.
// Pricing function also acts as pre-payment validation (throw HttpError to reject).
