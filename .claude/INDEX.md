...
| File | Description |
|------|-------------|
| `20_router-client-spec.md` | Spec for a companion client package that consumes router-powered APIs using `z.fromJSONSchema()` for runtime-typesafe Zod-forward calls. |
